...
for P in range(int(P_min),int(P_max),2000):
	...
	#to pick the selected pressure only 
	'''
	if P != P_select:   
		continue 
	...
	#originally 1E+2 
	#generate rings
	#to generate 70% pion, 24% proton, 6% kaon 
	for i in range(0,int(6E+2)): 
		#number of coincidences (see photonGen fun)  
		Nc1,up1,down1,left1,right1= photonGeneration(r,mka) 		
...
for P in range(int(P_min),int(P_max),2000):
	...
	#generate rings
	#to generate 70% pion, 24% proton, 6% kaon 
	for i in range(0,int(24E+2)):
		#number of coincidences (see photonGen fun)  
		Nc2,up2,down2,left2,right2= photonGeneration(r,mpr) 		
		#add to respective lists 
		sumup2 += up2 
		sumdown2 += down2 
		sumleft2 += left2
...
for P in range(int(P_min),int(P_max),2000):
	...
	#generate rings
	#to generate 70% pion, 24% proton, 6% kaon 
	for i in range(0,int(70E+2)):
		#number of coincidences (see photonGen fun)  
		Nc3,up3,down3,left3,right3= photonGeneration(r,mpi) 		
		#add to respective lists 
		sumup2 += up2 
		sumdown2 += down2 
		sumleft2 += left2
...
#total assymetries
print("\nCombined asymmetries for the kaon, proton, and pion:") 
sumuptot = sumup1 + sumup2 + sumup3 
sumdowntot = sumdown1 + sumdown2 +sumdown3
sumlefttot = sumleft1 + sumleft2 + sumleft3 
sumrighttot = sumright1 + sumright2 + sumright3 
getAsymmetries(sumuptot,sumdowntot,sumlefttot,sumrighttot) 
